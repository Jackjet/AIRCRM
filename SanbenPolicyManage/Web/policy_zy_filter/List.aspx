<%@ Page Title="policy_zy_filter" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Sanben.Web.policy_zy_filter.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="limit_type" HeaderText="limit_type" SortExpression="limit_type" ItemStyle-HorizontalAlign="Center"  /> 
