<%@ Page Title="ROUTE" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Sanben.Web.ROUTE.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="SCITY" HeaderText="出发城市三字代码" SortExpression="SCITY" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ECITY" HeaderText="到达城市三字代码" SortExpression="ECITY" ItemStyle-HorizontalAlign="Center"  /> 
