<%@ Page Title="NewOrderInfo" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Sanben.Web.NewOrderInfo.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="pk_id" HeaderText="pk_id" SortExpression="pk_id" ItemStyle-HorizontalAlign="Center"  /> 
