<%@ Page Title="policy_zy_tuigaiqian" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Sanben.Web.policy_zy_tuigaiqian.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="initiaie_mode" HeaderText="initiaie_mode" SortExpression="initiaie_mode" ItemStyle-HorizontalAlign="Center"  /> 
