...
namespace Sanben.Web.Orderinfo
{
	...
	private void ShowInfo(int pk_id)
	{
		...
		Sanben.Model.Orderinfo model=bll.GetModel(pk_id);
		this.lblpk_id.Text=model.pk_id.ToString();
		this.txtid.Text=model.id.ToString();
		this.txtorderNo.Text=model.orderNo;
		this.txtallPrice.Text=model.allPrice;
		this.txtnoPay.Text=model.noPay;
		this.txtchildPrintPrice.Text=model.childPrintPrice;
		this.txtchildFaceValue.Text=model.childFaceValue;
		this.txtsource.Text=model.source;
		this.txtpolicySource.Text=model.policySource;
		this.txtticketMode.Text=model.ticketMode;
		this.txtpolicyFriendly.Text=model.policyFriendly;
		this.txtpayChannel.Text=model.payChannel;
		this.txtpayStatus.Text=model.payStatus;
		this.txtinsuranceUnitPrice.Text=model.insuranceUnitPrice;
		this.txtbacknote.Text=model.backnote;
		this.txtinsuranceCuttingPrice.Text=model.insuranceCuttingPrice;
		this.txtcabinnote.Text=model.cabinnote;
		this.txtxcdPrice.Text=model.xcdPrice;
		this.txtxcd.Text=model.xcd;
		this.txtsjr.Text=model.sjr;
		this.txtcontactTel.Text=model.contactTel;
		this.txtaddress.Text=model.address;
		this.txtcompany.Text=model.company;
		this.txtexpType.Text=model.expType;
		this.txtordernumber.Text=model.ordernumber;
		this.txtsendtime.Text=model.sendtime;
		this.txtviewPrice.Text=model.viewPrice;
		this.txtprice.Text=model.price;
		this.txtpnr.Text=model.pnr;
		this.txtcpnr.Text=model.cpnr;
		this.txtpnrText.Text=model.pnrText;
		this.txtchildPnrText.Text=model.childPnrText;
		this.txtpataText.Text=model.pataText;
		this.txtchildPataText.Text=model.childPataText;
		this.txtconstructionFee.Text=model.constructionFee;
		this.txtfuelTax.Text=model.fuelTax;
		...
		this.txtcontactMob.Text=model.contactMob;
		this.txtcontactEmail.Text=model.contactEmail;
		this.txtcreateTime.Text=model.createTime.ToString();
		this.txtneedPS.Text=model.needPS;
		this.txtusername.Text=model.username;
		this.txtorderFrom.Text=model.orderFrom;
		this.txtlockStatus.Text=model.lockStatus;
		this.txtupdateTime.Text=model.updateTime.ToString();
		this.txtuserid.Text=model.userid.ToString();
		this.txtorderDesc.Text=model.orderDesc;
		this.txtpolicy.Text=model.policy.ToString();
		...
		public void btnSave_Click(object sender, EventArgs e)
		{
			...
			if(!PageValidate.IsNumber(txtpolicy.Text))
			{
				strErr+="policy格式错误！\\n";	
			}
			...
			int policy=int.Parse(this.txtpolicy.Text);


			Sanben.Model.Orderinfo model=new Sanben.Model.Orderinfo();
			model.pk_id=pk_id;
			model.id=id;
