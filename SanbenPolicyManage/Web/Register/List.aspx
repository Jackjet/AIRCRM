<%@ Page Title="Register" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Sanben.Web.Register.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="login_date" HeaderText="login_date" SortExpression="login_date" ItemStyle-HorizontalAlign="Center"  /> 
