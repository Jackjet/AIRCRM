<%@ Page Title="1" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Sanben.Web.UploadPolicyResult.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="startMode" HeaderText="startMode" SortExpression="startMode" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="uploadNumber" HeaderText="uploadNumber" SortExpression="uploadNumber" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="errorNumber" HeaderText="errorNumber" SortExpression="errorNumber" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="noticeTime" HeaderText="noticeTime" SortExpression="noticeTime" ItemStyle-HorizontalAlign="Center"  /> 
