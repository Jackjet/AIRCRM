<%@ Page Title="policy_zy_pat" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Sanben.Web.policy_zy_pat.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="patCheck" HeaderText="patCheck" SortExpression="patCheck" ItemStyle-HorizontalAlign="Center"  /> 
