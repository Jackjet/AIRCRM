<%@ Page Title="ctripPolicyRebate" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Sanben.Web.ctripPolicyRebate.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="returnType" HeaderText="returnType" SortExpression="returnType" ItemStyle-HorizontalAlign="Center"  /> 
