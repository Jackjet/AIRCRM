<%@ Page Title="ctripPolicyOptions" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Sanben.Web.ctripPolicyOptions.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="ticket_price_set" HeaderText="ticket_price_set" SortExpression="ticket_price_set" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="workTimeLimit" HeaderText="workTimeLimit" SortExpression="workTimeLimit" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="off_number" HeaderText="off_number" SortExpression="off_number" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="is_orientate" HeaderText="is_orientate" SortExpression="is_orientate" ItemStyle-HorizontalAlign="Center"  /> 
