<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Sanben.Web.rebate_wangfan.Modify" Title="修改页" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtqucheng_space" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		huicheng_space
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txthuicheng_space" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		rabate_number
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtticket_price_lowest" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtticket_price_highest" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		rabate_class
