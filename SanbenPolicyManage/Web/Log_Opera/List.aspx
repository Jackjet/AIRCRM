<%@ Page Title="Log_Opera" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Sanben.Web.Log_Opera.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="action" HeaderText="action" SortExpression="action" ItemStyle-HorizontalAlign="Center"  /> 
