<%@ Page Title="menu" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Sanben.Web.menu.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="menuname" HeaderText="menuname" SortExpression="menuname" ItemStyle-HorizontalAlign="Center"  /> 
