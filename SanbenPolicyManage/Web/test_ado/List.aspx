<%@ Page Title="1" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Sanben.Web.test_ado.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="ADD" HeaderText="ADD" SortExpression="ADD" ItemStyle-HorizontalAlign="Center"  /> 
