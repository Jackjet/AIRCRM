<%@ Page Title="sys_user" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Sanben.Web.sys_user.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="IsModify" HeaderText="IsModify" SortExpression="IsModify" ItemStyle-HorizontalAlign="Center"  /> 
