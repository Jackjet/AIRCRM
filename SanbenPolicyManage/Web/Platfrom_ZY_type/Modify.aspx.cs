...
namespace Sanben.Web.Platfrom_ZY_type
{
	...
	{
		Sanben.BLL.Platfrom_ZY_type bll=new Sanben.BLL.Platfrom_ZY_type();
		Sanben.Model.Platfrom_ZY_type model=bll.GetModel(id);
