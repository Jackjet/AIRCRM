...
namespace Sanben.Web.Policy
{
	...
	private void ShowInfo(int id)
	{
		...
		this.txtflightNumLimit.Text=model.flightNumLimit;
		this.txtflightcondition.Text=model.flightcondition;
		this.txtdaycondition.Text=model.daycondition;
		this.txtcabin.Text=model.cabin;
		this.txtdiscountType.Text=model.discountType;
		this.txtdiscountValue.Text=model.discountValue;
		this.txtreturnpoint.Text=model.returnpoint.ToString();
		this.txtreturnprice.Text=model.returnprice.ToString();
		this.txtstartdate_ticket.Text=model.startdate_ticket.ToString();
		this.txtenfdate_ticket.Text=model.enfdate_ticket.ToString();
		this.txtstartdate.Text=model.startdate.ToString();
		this.txtenddate.Text=model.enddate.ToString();
		this.txtbeforeValidDay.Text=model.beforeValidDay.ToString();
		this.txtbacknote.Text=model.backnote;
		this.txtcabinnote.Text=model.cabinnote;
		this.chkautoTicket.Checked=model.autoTicket;
		this.chkshared.Checked=model.shared;
		this.txtofficeno.Text=model.officeno;
		this.txtktype.Text=model.ktype;
		this.txtcheckCycleTime.Text=model.checkCycleTime.ToString();
		this.txtautoCheckOverTime.Text=model.autoCheckOverTime.ToString();
		this.txtmanualCheckOverTime.Text=model.manualCheckOverTime.ToString();
		this.txtpolicy.Text=model.policy;
		this.txtdownDiscount.Text=model.downDiscount.ToString();
		this.chkpata.Checked=model.pata;
		this.txtspecialRule.Text=model.specialRule;
		this.txtallCabin.Text=model.allCabin.ToString();
		this.chkcanPay.Checked=model.canPay;
		this.txtdeptTimeSlot.Text=model.deptTimeSlot;
		this.chkneedPnr.Checked=model.needPnr;
		this.txtone_flightlimit.Text=model.one_flightlimit;
		this.txtone_limitnum.Text=model.one_limitnum;
		this.txttwo_flightlimit.Text=model.two_flightlimit;
		this.txttwo_limitnum.Text=model.two_limitnum;
		this.txtone_daylimit.Text=model.one_daylimit;
		this.txttwo_daylimit.Text=model.two_daylimit;
		this.txtgocabin.Text=model.gocabin;
		this.txtbackcabin.Text=model.backcabin;
		this.txtone_startdate.Text=model.one_startdate.ToString();
		this.txtone_enddate.Text=model.one_enddate.ToString();
		this.txttwo_startdate.Text=model.two_startdate.ToString();
		this.txttwo_enddate.Text=model.two_enddate.ToString();
		this.txtshort_stoptime.Text=model.short_stoptime.ToString();
		this.txtlong_stoptime.Text=model.long_stoptime.ToString();
		this.txtcosttype.Text=model.costtype;
		this.txtcostPrice.Text=model.costPrice.ToString();
		this.txtproxyPrice.Text=model.proxyPrice.ToString();
		this.txtbackPrice.Text=model.backPrice.ToString();
		this.txtpolicySource.Text=model.policySource;
		this.txtxcd.Text=model.xcd;
		this.txtreturnRule.Text=model.returnRule;
		this.txtchangeRule.Text=model.changeRule;
		this.chkendorsement.Checked=model.endorsement;
		this.chkflyerpoints.Checked=model.flyerpoints;
		this.txtcardType.Text=model.cardType.ToString();
		...
		this.txtuploadPolicyType.Text=model.uploadPolicyType;
		this.txtearliestBeforeValidDay.Text=model.earliestBeforeValidDay.ToString();
		this.txtisUpload.Text=model.isUpload.ToString();
		this.txtimportTime.Text=model.importTime.ToString();
		this.txtuploadPlat.Text=model.uploadPlat;
		this.txtuploadResult.Text=model.uploadResult.ToString();
