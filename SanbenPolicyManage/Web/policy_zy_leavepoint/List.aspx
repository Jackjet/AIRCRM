<%@ Page Title="policy_zy_leavepoint" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Sanben.Web.policy_zy_leavepoint.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="application_space" HeaderText="application_space" SortExpression="application_space" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="leave_point" HeaderText="leave_point" SortExpression="leave_point" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="enddate_ticket" HeaderText="enddate_ticket" SortExpression="enddate_ticket" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="traveldate" HeaderText="traveldate" SortExpression="traveldate" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="isleavepointandmoney" HeaderText="isleavepointandmoney" SortExpression="isleavepointandmoney" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="isSet" HeaderText="isSet" SortExpression="isSet" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="remark" HeaderText="remark" SortExpression="remark" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="changedate" HeaderText="changedate" SortExpression="changedate" ItemStyle-HorizontalAlign="Center"  /> 
