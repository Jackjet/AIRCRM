<%@ Page Title="policy_options_wangfan" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Sanben.Web.policy_options_wangfan.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="tolerate_refund_change_rule" HeaderText="tolerate_refund_change_rule" SortExpression="tolerate_refund_change_rule" ItemStyle-HorizontalAlign="Center"  /> 
