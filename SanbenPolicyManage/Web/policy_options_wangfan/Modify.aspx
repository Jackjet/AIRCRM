<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Sanben.Web.policy_options_wangfan.Modify" Title="修改页" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	<tr>
	<td height="25" width="30%" align="right">
		tolerate_refund_change_rule
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txttolerate_refund_change_rule" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		class_description
