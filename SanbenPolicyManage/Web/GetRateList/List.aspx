<%@ Page Title="GetRateList" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Sanben.Web.GetRateList.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="comReturn" HeaderText="comReturn" SortExpression="comReturn" ItemStyle-HorizontalAlign="Center"  /> 
