<%@ Page Title="API380Ticket" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Sanben.Web.API380Ticket.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="bigpnr" HeaderText="bigpnr" SortExpression="bigpnr" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="air" HeaderText="air" SortExpression="air" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="totaltax" HeaderText="totaltax" SortExpression="totaltax" ItemStyle-HorizontalAlign="Center"  /> 
