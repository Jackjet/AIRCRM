<%@ Page Title="sysAdminUser" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Sanben.Web.sysAdminUser.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="RoleList" HeaderText="RoleList" SortExpression="RoleList" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="CheckAuthority" HeaderText="CheckAuthority" SortExpression="CheckAuthority" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Stop" HeaderText="Stop" SortExpression="Stop" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="IsMoify" HeaderText="IsMoify" SortExpression="IsMoify" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Remark" HeaderText="Remark" SortExpression="Remark" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="RealName" HeaderText="RealName" SortExpression="RealName" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="Emaile" HeaderText="Emaile" SortExpression="Emaile" ItemStyle-HorizontalAlign="Center"  /> 
