...
namespace Sanben.Web.kuXunPolicyOptions
{
	...
	private void ShowInfo(int id)
	{
		...
		this.txtagent_rate.Text=model.agent_rate.ToString();
		this.txtinsurance_number.Text=model.insurance_number.ToString();
		this.chkfoundPnr.Checked=model.foundPnr;
		this.chkis_mail_itinerary.Checked=model.is_mail_itinerary;
		this.txtvalidatePatA.Text=model.validatePatA;
		this.txtvalidateClass.Text=model.validateClass.ToString();
