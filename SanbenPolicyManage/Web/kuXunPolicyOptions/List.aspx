<%@ Page Title="kuXunPolicyOptions" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Sanben.Web.kuXunPolicyOptions.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="agent_rate" HeaderText="agent_rate" SortExpression="agent_rate" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="insurance_number" HeaderText="insurance_number" SortExpression="insurance_number" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="foundPnr" HeaderText="foundPnr" SortExpression="foundPnr" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="validatePatA" HeaderText="validatePatA" SortExpression="validatePatA" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="validateClass" HeaderText="validateClass" SortExpression="validateClass" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="refund_change_rule" HeaderText="refund_change_rule" SortExpression="refund_change_rule" ItemStyle-HorizontalAlign="Center"  /> 
