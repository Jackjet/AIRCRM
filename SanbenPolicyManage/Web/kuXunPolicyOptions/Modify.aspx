<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Sanben.Web.kuXunPolicyOptions.Modify" Title="修改页" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtagent_rate" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		insurance_number
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtinsurance_number" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		foundPnr
	：</td>
	<td height="25" width="*" align="left">
		<asp:CheckBox ID="chkfoundPnr" Text="foundPnr" runat="server" Checked="False" />
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		is_mail_itinerary
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtvalidatePatA" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		validateClass
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtvalidateClass" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		refund_change_rule
