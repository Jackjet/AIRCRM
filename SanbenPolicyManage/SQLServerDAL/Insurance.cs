...
namespace Sanben.SQLServerDAL
{
	...
	/// 数据访问类:Insurance
	/// </summary>
	public partial class Insurance:IInsurance
	{
		public Insurance()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Insurance"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Insurance");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Sanben.Model.Insurance model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Insurance(");
			strSql.Append("insuranceNo,bxFlight,bxStatus,p_id)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sanben.Model.Insurance model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Insurance set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Insurance ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.Insurance GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,insuranceNo,bxFlight,bxStatus,p_id from Insurance ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.Insurance DataRowToModel(DataRow row)
		{
			Sanben.Model.Insurance model=new Sanben.Model.Insurance();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Insurance T ");
