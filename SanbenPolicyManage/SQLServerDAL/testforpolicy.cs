...
namespace Sanben.SQLServerDAL
{
	...
	/// 数据访问类:testforpolicy
	/// </summary>
	public partial class testforpolicy:Itestforpolicy
	{
		public testforpolicy()
		{}
		#region  BasicMethod
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Sanben.Model.testforpolicy model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into testforpolicy(");
			...
			parameters[39].Value = model.AddTime;
			parameters[40].Value = model.Flag;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sanben.Model.testforpolicy model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update testforpolicy set ");
			strSql.Append("ID=@ID,");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from testforpolicy ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.testforpolicy DataRowToModel(DataRow row)
		{
			Sanben.Model.testforpolicy model=new Sanben.Model.testforpolicy();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM testforpolicy ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM testforpolicy ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from testforpolicy T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "testforpolicy";
