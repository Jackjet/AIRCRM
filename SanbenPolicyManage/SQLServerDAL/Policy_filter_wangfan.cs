...
{
	/// <summary>
	/// 数据访问类:Policy_filter_wangfan
	/// </summary>
	public partial class Policy_filter_wangfan:IPolicy_filter_wangfan
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Policy_filter_wangfan"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Policy_filter_wangfan");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Sanben.Model.Policy_filter_wangfan model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Policy_filter_wangfan(");
			strSql.Append("navigation_company,air_line,qucheng_space,huicheng_space,limit_type,sys_id,platform_type_id)");
			strSql.Append(" values (");
			strSql.Append("@navigation_company,@air_line,@qucheng_space,@huicheng_space,@limit_type,@sys_id,@platform_type_id)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@navigation_company", SqlDbType.VarChar,150),
			...
			parameters[4].Value = model.limit_type;
			parameters[5].Value = model.sys_id;
			parameters[6].Value = model.platform_type_id;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sanben.Model.Policy_filter_wangfan model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Policy_filter_wangfan set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Policy_filter_wangfan ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.Policy_filter_wangfan GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,navigation_company,air_line,qucheng_space,huicheng_space,limit_type,sys_id,platform_type_id from Policy_filter_wangfan ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.Policy_filter_wangfan DataRowToModel(DataRow row)
		{
			Sanben.Model.Policy_filter_wangfan model=new Sanben.Model.Policy_filter_wangfan();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,navigation_company,air_line,qucheng_space,huicheng_space,limit_type,sys_id,platform_type_id ");
			strSql.Append(" FROM Policy_filter_wangfan ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,navigation_company,air_line,qucheng_space,huicheng_space,limit_type,sys_id,platform_type_id ");
			strSql.Append(" FROM Policy_filter_wangfan ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Policy_filter_wangfan T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Policy_filter_wangfan";
