...
namespace Sanben.SQLServerDAL
{
	...
	/// 数据访问类:T_Airport
	/// </summary>
	public partial class T_Airport:IT_Airport
	{
		public T_Airport()
		{}
		#region  BasicMethod
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Sanben.Model.T_Airport model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into T_Airport(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sanben.Model.T_Airport model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update T_Airport set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from T_Airport ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.T_Airport GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,airport_code,airport_city,airport_name from T_Airport ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Sanben.Model.T_Airport model=new Sanben.Model.T_Airport();
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.T_Airport DataRowToModel(DataRow row)
		{
			Sanben.Model.T_Airport model=new Sanben.Model.T_Airport();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM T_Airport ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from T_Airport T ");
