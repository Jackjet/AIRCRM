...
{
	/// <summary>
	/// 数据访问类:BackupPurchaseOrderInfo
	/// </summary>
	public partial class BackupPurchaseOrderInfo:IBackupPurchaseOrderInfo
	{
		public BackupPurchaseOrderInfo()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "BackupPurchaseOrderInfo"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from BackupPurchaseOrderInfo");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Sanben.Model.BackupPurchaseOrderInfo model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into BackupPurchaseOrderInfo(");
			...
			parameters[2].Value = model.issue_ticket_type;
			parameters[3].Value = model.issue_ticket_platform_code;
			parameters[4].Value = model.source_transaction_id;
			parameters[5].Value = model.source_order_no;
			parameters[6].Value = model.tpp_type;
			parameters[7].Value = model.status;
			parameters[8].Value = model.pay_commercial_no;
			parameters[9].Value = model.offline_pay_type;
			parameters[10].Value = model.offline_pay_cardno;
			parameters[11].Value = model.platform_mem_id;
			parameters[12].Value = model.PurchaseOperator;
			parameters[13].Value = model.refund_price;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sanben.Model.BackupPurchaseOrderInfo model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update BackupPurchaseOrderInfo set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from BackupPurchaseOrderInfo ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)			};
			parameters[0].Value = id;
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.BackupPurchaseOrderInfo GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,price,issue_ticket_type,issue_ticket_platform_code,source_transaction_id,source_order_no,tpp_type,status,pay_commercial_no,offline_pay_type,offline_pay_cardno,platform_mem_id,operator,refund_price,o_id from BackupPurchaseOrderInfo ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)			};
			parameters[0].Value = id;

			Sanben.Model.BackupPurchaseOrderInfo model=new Sanben.Model.BackupPurchaseOrderInfo();
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.BackupPurchaseOrderInfo DataRowToModel(DataRow row)
		{
			Sanben.Model.BackupPurchaseOrderInfo model=new Sanben.Model.BackupPurchaseOrderInfo();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM BackupPurchaseOrderInfo ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from BackupPurchaseOrderInfo T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "BackupPurchaseOrderInfo";
