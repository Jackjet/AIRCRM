...
{
	/// <summary>
	/// 数据访问类:gaiqian_retirement
	/// </summary>
	public partial class gaiqian_retirement:Igaiqian_retirement
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "gaiqian_retirement"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from gaiqian_retirement");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Sanben.Model.gaiqian_retirement model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into gaiqian_retirement(");
			strSql.Append("navigation_company,air_line,application_space,initiate_mode,startDate,endDate,refund_rule,changedate_rule,is_allowed_sign,sys_id,platform_type_id)");
			...
			parameters[6].Value = model.refund_rule;
			parameters[7].Value = model.changedate_rule;
			parameters[8].Value = model.is_allowed_sign;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sanben.Model.gaiqian_retirement model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update gaiqian_retirement set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from gaiqian_retirement ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.gaiqian_retirement GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,navigation_company,air_line,application_space,initiate_mode,startDate,endDate,refund_rule,changedate_rule,is_allowed_sign,sys_id,platform_type_id from gaiqian_retirement ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.gaiqian_retirement DataRowToModel(DataRow row)
		{
			Sanben.Model.gaiqian_retirement model=new Sanben.Model.gaiqian_retirement();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,navigation_company,air_line,application_space,initiate_mode,startDate,endDate,refund_rule,changedate_rule,is_allowed_sign,sys_id,platform_type_id ");
			strSql.Append(" FROM gaiqian_retirement ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,navigation_company,air_line,application_space,initiate_mode,startDate,endDate,refund_rule,changedate_rule,is_allowed_sign,sys_id,platform_type_id ");
			strSql.Append(" FROM gaiqian_retirement ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from gaiqian_retirement T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "gaiqian_retirement";
