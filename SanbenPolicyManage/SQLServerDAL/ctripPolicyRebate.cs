...
{
	/// <summary>
	/// 数据访问类:ctripPolicyRebate
	/// </summary>
	public partial class ctripPolicyRebate:IctripPolicyRebate
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "ctripPolicyRebate"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from ctripPolicyRebate");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Sanben.Model.ctripPolicyRebate model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into ctripPolicyRebate(");
			strSql.Append("navigation_company,air_line,application_space,rabate_number,leave_money,ticket_price_lowest,ticket_price_highest,rabate_class,returnType,sys_id,platform_type_id)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@returnType", SqlDbType.VarChar,10),
			...
			parameters[4].Value = model.leave_money;
			parameters[5].Value = model.ticket_price_lowest;
			parameters[6].Value = model.ticket_price_highest;
			parameters[7].Value = model.rabate_class;
			parameters[8].Value = model.returnType;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sanben.Model.ctripPolicyRebate model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update ctripPolicyRebate set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from ctripPolicyRebate ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.ctripPolicyRebate GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,navigation_company,air_line,application_space,rabate_number,leave_money,ticket_price_lowest,ticket_price_highest,rabate_class,returnType,sys_id,platform_type_id from ctripPolicyRebate ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.ctripPolicyRebate DataRowToModel(DataRow row)
		{
			Sanben.Model.ctripPolicyRebate model=new Sanben.Model.ctripPolicyRebate();
			if (row != null)
			{
				...
				{
					model.returnType=row["returnType"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,navigation_company,air_line,application_space,rabate_number,leave_money,ticket_price_lowest,ticket_price_highest,rabate_class,returnType,sys_id,platform_type_id ");
			strSql.Append(" FROM ctripPolicyRebate ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,navigation_company,air_line,application_space,rabate_number,leave_money,ticket_price_lowest,ticket_price_highest,rabate_class,returnType,sys_id,platform_type_id ");
			strSql.Append(" FROM ctripPolicyRebate ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from ctripPolicyRebate T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "ctripPolicyRebate";
