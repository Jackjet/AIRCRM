...
namespace Sanben.SQLServerDAL
{
	...
	public partial class Passenger:IPassenger
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Passenger"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Passenger");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Sanben.Model.Passenger model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Passenger(");
			strSql.Append("name,ageType,cardType,price,priceType,cardNum,eticketNum,insuranceCount,bxSource,bxName,o_id)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sanben.Model.Passenger model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Passenger set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Passenger ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.Passenger GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,name,ageType,cardType,price,priceType,cardNum,eticketNum,insuranceCount,bxSource,bxName,o_id from Passenger ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.Passenger DataRowToModel(DataRow row)
		{
			Sanben.Model.Passenger model=new Sanben.Model.Passenger();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Passenger T ");
