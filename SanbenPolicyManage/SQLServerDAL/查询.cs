...
namespace Sanben.SQLServerDAL
{
	...
	public partial class 查询:I查询
	{
		...
		public bool Add(Sanben.Model.查询 model)
		{
			...
			parameters[2].Value = model.From_Code;
			parameters[3].Value = model.To_Code;
			parameters[4].Value = model.StartCity;
			parameters[5].Value = model.ArriveCity;
			parameters[6].Value = model.Mileage;
			parameters[7].Value = model.Fule_Adult;
			parameters[8].Value = model.Fule_Child;
			parameters[9].Value = model.Line_Number;
			parameters[10].Value = model.Share_Line;
			parameters[11].Value = model.Company;
			parameters[12].Value = model.StartCode;
			parameters[13].Value = model.StartAirport;
			parameters[14].Value = model.ArriveCode;
			parameters[15].Value = model.ArriveAirport;
			parameters[16].Value = model.StartTime;
			parameters[17].Value = model.ArriveTime;
			parameters[18].Value = model.AirRax;
			parameters[19].Value = model.FuleRax;
			parameters[20].Value = model.FuelAdu;
			parameters[21].Value = model.FuelChd;
			parameters[22].Value = model.Food;
			parameters[23].Value = model.Food_Detail;
			parameters[24].Value = model.Direct_Flight;
			parameters[25].Value = model.Type;
			parameters[26].Value = model.Electronic_Ticket;
			parameters[27].Value = model.Start_Terminal;
			parameters[28].Value = model.Arrive_Terminal;
			parameters[29].Value = model.Cabin;
			parameters[30].Value = model.ChildCabin;
			parameters[31].Value = model.Discount;
			parameters[32].Value = model.Price;
			parameters[33].Value = model.Surplus_Seat_Qty;
			parameters[34].Value = model.Cabin_Status;
			parameters[35].Value = model.Cabin_Point;
			parameters[36].Value = model.Validity_Period;
			parameters[37].Value = model.Return_Date;
			parameters[38].Value = model.Valid_Date;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sanben.Model.查询 model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update 查询 set ");
			strSql.Append("ID=@ID,");
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.查询 GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,Date,From_Code,To_Code,StartCity,ArriveCity,Mileage,Fule_Adult,Fule_Child,Line_Number,Share_Line,Company,StartCode,StartAirport,ArriveCode,ArriveAirport,StartTime,ArriveTime,AirRax,FuleRax,FuelAdu,FuelChd,Food,Food_Detail,Direct_Flight,Type,Electronic_Ticket,Start_Terminal,Arrive_Terminal,Cabin,ChildCabin,Discount,Price,Surplus_Seat_Qty,Cabin_Status,Cabin_Point,Validity_Period,Return_Date,Valid_Date from 查询 ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};

			Sanben.Model.查询 model=new Sanben.Model.查询();
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.查询 DataRowToModel(DataRow row)
		{
			Sanben.Model.查询 model=new Sanben.Model.查询();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM 查询 ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from 查询 T ");
