...
namespace Sanben.SQLServerDAL
{
	...
	/// 数据访问类:Log_Opera
	/// </summary>
	public partial class Log_Opera:ILog_Opera
	{
		public Log_Opera()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Log_Opera"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Log_Opera");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Sanben.Model.Log_Opera model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Log_Opera(");
			strSql.Append("operator,time,action,o_id)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sanben.Model.Log_Opera model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Log_Opera set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Log_Opera ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.Log_Opera GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,operator,time,action,o_id from Log_Opera ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.Log_Opera DataRowToModel(DataRow row)
		{
			Sanben.Model.Log_Opera model=new Sanben.Model.Log_Opera();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Log_Opera T ");
