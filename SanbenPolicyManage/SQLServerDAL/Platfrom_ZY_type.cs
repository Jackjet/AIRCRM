...
{
	/// <summary>
	/// 数据访问类:Platfrom_ZY_type
	/// </summary>
	public partial class Platfrom_ZY_type:IPlatfrom_ZY_type
	{
		public Platfrom_ZY_type()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Platfrom_ZY_type"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Platfrom_ZY_type");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Sanben.Model.Platfrom_ZY_type model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Platfrom_ZY_type(");
			strSql.Append("website_name,platform_interface,website_platfrom,platform_name,platform_id)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sanben.Model.Platfrom_ZY_type model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Platfrom_ZY_type set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Platfrom_ZY_type ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.Platfrom_ZY_type GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,website_name,platform_interface,website_platfrom,platform_name,platform_id from Platfrom_ZY_type ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Sanben.Model.Platfrom_ZY_type model=new Sanben.Model.Platfrom_ZY_type();
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.Platfrom_ZY_type DataRowToModel(DataRow row)
		{
			Sanben.Model.Platfrom_ZY_type model=new Sanben.Model.Platfrom_ZY_type();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM Platfrom_ZY_type ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Platfrom_ZY_type T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Platfrom_ZY_type";
