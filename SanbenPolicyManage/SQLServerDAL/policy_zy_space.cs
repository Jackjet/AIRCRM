...
{
	/// <summary>
	/// 数据访问类:policy_zy_space
	/// </summary>
	public partial class policy_zy_space:Ipolicy_zy_space
	{
		public policy_zy_space()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "policy_zy_space"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from policy_zy_space");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Sanben.Model.policy_zy_space model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into policy_zy_space(");
			strSql.Append("navigation_company,air_line,application_space,description,platform_id,sys_id)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sanben.Model.policy_zy_space model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update policy_zy_space set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from policy_zy_space ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.policy_zy_space GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,navigation_company,air_line,application_space,description,platform_id,sys_id from policy_zy_space ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.policy_zy_space DataRowToModel(DataRow row)
		{
			Sanben.Model.policy_zy_space model=new Sanben.Model.policy_zy_space();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,navigation_company,air_line,application_space,description,platform_id,sys_id ");
			strSql.Append(" FROM policy_zy_space ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,navigation_company,air_line,application_space,description,platform_id,sys_id ");
			strSql.Append(" FROM policy_zy_space ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from policy_zy_space T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "policy_zy_space";
