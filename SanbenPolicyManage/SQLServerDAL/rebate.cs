...
namespace Sanben.SQLServerDAL
{
	...
	/// 数据访问类:rebate
	/// </summary>
	public partial class rebate:Irebate
	{
		public rebate()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "rebate"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from rebate");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Sanben.Model.rebate model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into rebate(");
			strSql.Append("navigation_company,air_line,application_space,rabate_number,leave_money,ticket_price_lowest,ticket_price_highest,rabate_class,sys_id,platform_type_id)");
			...
			parameters[9].Value = model.platform_type_id;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sanben.Model.rebate model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update rebate set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from rebate ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.rebate GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,navigation_company,air_line,application_space,rabate_number,leave_money,ticket_price_lowest,ticket_price_highest,rabate_class,sys_id,platform_type_id from rebate ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Sanben.Model.rebate model=new Sanben.Model.rebate();
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.rebate DataRowToModel(DataRow row)
		{
			Sanben.Model.rebate model=new Sanben.Model.rebate();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,navigation_company,air_line,application_space,rabate_number,leave_money,ticket_price_lowest,ticket_price_highest,rabate_class,sys_id,platform_type_id ");
			strSql.Append(" FROM rebate ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,navigation_company,air_line,application_space,rabate_number,leave_money,ticket_price_lowest,ticket_price_highest,rabate_class,sys_id,platform_type_id ");
			strSql.Append(" FROM rebate ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from rebate T ");
