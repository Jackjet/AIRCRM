...
{
	/// <summary>
	/// 数据访问类:policy_zy_ticket
	/// </summary>
	public partial class policy_zy_ticket:Ipolicy_zy_ticket
	{
		public policy_zy_ticket()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "policy_zy_ticket"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from policy_zy_ticket");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Sanben.Model.policy_zy_ticket model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into policy_zy_ticket(");
			strSql.Append("navigation_company,air_line,application_space,startdate_ticket,enddate_ticket,changedate,platform_id,sys_id)");
			...
			parameters[3].Value = model.startdate_ticket;
			parameters[4].Value = model.enddate_ticket;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sanben.Model.policy_zy_ticket model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update policy_zy_ticket set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from policy_zy_ticket ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.policy_zy_ticket GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,navigation_company,air_line,application_space,startdate_ticket,enddate_ticket,changedate,platform_id,sys_id from policy_zy_ticket ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.policy_zy_ticket DataRowToModel(DataRow row)
		{
			Sanben.Model.policy_zy_ticket model=new Sanben.Model.policy_zy_ticket();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,navigation_company,air_line,application_space,startdate_ticket,enddate_ticket,changedate,platform_id,sys_id ");
			strSql.Append(" FROM policy_zy_ticket ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,navigation_company,air_line,application_space,startdate_ticket,enddate_ticket,changedate,platform_id,sys_id ");
			strSql.Append(" FROM policy_zy_ticket ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from policy_zy_ticket T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "policy_zy_ticket";
