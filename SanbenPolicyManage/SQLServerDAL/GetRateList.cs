...
namespace Sanben.SQLServerDAL
{
	...
	/// 数据访问类:GetRateList
	/// </summary>
	public partial class GetRateList:IGetRateList
	{
		public GetRateList()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "GetRateList"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from GetRateList");
		...
		public int Add(Sanben.Model.GetRateList model)
		{
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@comReturn", SqlDbType.NVarChar,255),
			...
			parameters[40].Value = model.comReturn;
			parameters[41].Value = model.PlatForm;
			parameters[42].Value = model.AddTime;
			parameters[43].Value = model.Company;
			parameters[44].Value = model.AirLine;
			parameters[45].Value = model.IsUpload;
			parameters[46].Value = model.IsUpdate;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sanben.Model.GetRateList model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update GetRateList set ");
			...
			strSql.Append("comReturn=@comReturn,");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from GetRateList ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.GetRateList DataRowToModel(DataRow row)
		{
			Sanben.Model.GetRateList model=new Sanben.Model.GetRateList();
			if (row != null)
			{
				...
				if(row["comReturn"]!=null)
				{
					model.comReturn=row["comReturn"].ToString();
				}
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM GetRateList ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from GetRateList T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "GetRateList";
