...
namespace Sanben.SQLServerDAL
{
	...
	public partial class Flight:IFlight
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Flight"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Flight");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Sanben.Model.Flight model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Flight(");
			strSql.Append("code,cabin,ccabin,dep,arr,depDay,depTime,arrTime,realCode,o_id)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sanben.Model.Flight model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Flight set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Flight ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.Flight GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,code,cabin,ccabin,dep,arr,depDay,depTime,arrTime,realCode,o_id from Flight ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.Flight DataRowToModel(DataRow row)
		{
			Sanben.Model.Flight model=new Sanben.Model.Flight();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Flight T ");
