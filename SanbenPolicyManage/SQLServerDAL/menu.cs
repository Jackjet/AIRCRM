...
namespace Sanben.SQLServerDAL
{
	...
	public partial class menu:Imenu
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "menu"); 
		}
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Sanben.Model.menu model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into menu(");
			strSql.Append("icon,menuname,url,parentId,sort,remark,stop)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sanben.Model.menu model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.menu GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,icon,menuname,url,parentId,sort,remark,stop from menu ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.menu DataRowToModel(DataRow row)
		{
			Sanben.Model.menu model=new Sanben.Model.menu();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,icon,menuname,url,parentId,sort,remark,stop ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,icon,menuname,url,parentId,sort,remark,stop ");
			strSql.Append(" FROM menu ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
