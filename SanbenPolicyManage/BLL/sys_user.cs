...
namespace Sanben.BLL
{
	...
	public partial class sys_user
	{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Sanben.Model.sys_user GetModelByCache(int id)
		{
			...
			return (Sanben.Model.sys_user)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Sanben.Model.sys_user> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Sanben.Model.sys_user> DataTableToList(DataTable dt)
		{
			List<Sanben.Model.sys_user> modelList = new List<Sanben.Model.sys_user>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Sanben.Model.sys_user model;
