...
namespace Sanben.BLL
{
	...
	public partial class sysdiagrams
	{
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(Sanben.Model.sysdiagrams model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Sanben.Model.sysdiagrams model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public Sanben.Model.sysdiagrams GetModel(int diagram_id)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Sanben.Model.sysdiagrams GetModelByCache(int diagram_id)
		{
			...
			return (Sanben.Model.sysdiagrams)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Sanben.Model.sysdiagrams> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Sanben.Model.sysdiagrams> DataTableToList(DataTable dt)
		{
			List<Sanben.Model.sysdiagrams> modelList = new List<Sanben.Model.sysdiagrams>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Sanben.Model.sysdiagrams model;
